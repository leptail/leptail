...
pub fn PageSwitch() -> impl IntoView { 
    ...
    view! { 
        ...
        <div class="flex flex-col gap-4" >
            <Switch is_on={s1} set_on=set_s1 variant=SwitchVariant::variant(Color::Default.into(), None)  />
            <Switch is_on={s2} set_on=set_s2 variant=SwitchVariant::variant(Color::Primary.into(), None)  />
            <Switch is_on={s3} set_on=set_s3 disabled=true variant=SwitchVariant::variant(Color::Warning.into(), Size::Large.into())  />
            ...
            />
            <Switch is_on={s1} set_on=set_s1 variant=SwitchVariant::variant(Color::Success.into(), Size::Large.into()) 
